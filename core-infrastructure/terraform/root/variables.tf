...
variable "privatelink_subnet_service_endpoints" {
  ...
  type        = list(string)
  default     = ["Microsoft.KeyVault", "Microsoft.Storage", "Microsoft.AzureCosmosDB", "Microsoft.ContainerRegistry"]
}
...
variable "appservice_subnet_service_endpoints" {
  ...
  type        = list(string)
  default     = ["Microsoft.Web", "Microsoft.Storage", "Microsoft.AzureCosmosDB", "Microsoft.ContainerRegistry"]
}
