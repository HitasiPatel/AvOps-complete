...
from avcloudapicommons.instrumentation import BaseIntrumentator, handle_exception
from avcloudapicommons.instrumentation.settings import Settings
...
class BatchInstrumentator(BaseIntrumentator):
    def __init__(
        ...
        super().__init__(
            component_name or setting.APPLICATIONINSIGHTS_ROLENAME,
            sampler,
            exporter,
            propogator,
        )
